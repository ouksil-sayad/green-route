...
import { Sun, Moon, Loader2, Settings, ArrowRightLeft, Clock, DollarSign, Leaf, ChevronDown, ChevronUp } from "lucide-react";
    ...
    <div style={{ width: "100vw", height: "100vh", position: "relative", overflow: "hidden" }}>
      ...
      >
        ...
        <div>
          ...
          <div style={{ fontSize: "8px", fontWeight: 600, color: "#6b8a7a", textTransform: "uppercase", letterSpacing: "1px" }}>User Mode</div>
        </div>
      </div>
      ...
      {/* ── FLOATING BOTTOM DASHBOARD WRAPPER ── */}
      <div
        style={{
          position: "fixed",
          bottom: 0,
          left: "50%",
          transform: `translateX(-50%) translateY(${isDashboardVisible ? "-20px" : "calc(100% - 36px)"})`,
          zIndex: 1200,
          width: "calc(100% - 40px)",
          maxWidth: "900px",
          display: "flex",
      ...
      >
        ...
        <button
          ...
          title={isDashboardVisible ? "Hide Dashboard" : "Show Dashboard"}
        >
          {isDashboardVisible ? <ChevronDown size={16} /> : <ChevronUp size={16} />}
        </button>
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "8px", flexWrap: "wrap" }}>
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div style={{ fontSize: "13px", fontWeight: startNode ? 600 : 400, color: startNode ? "#1a2e24" : "#8ca89a", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div style={{ fontSize: "13px", fontWeight: endNode ? 600 : 400, color: endNode ? "#1a2e24" : "#8ca89a", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "16px", flexWrap: "wrap" }}>
            ...
            <div style={{ flex: 1, display: "flex", gap: "16px", minWidth: "280px", flexWrap: "wrap" }}>
              {[
                { icon: <Clock size={12} />, label: "Time", value: timeWeight, setter: setTimeWeight, key: "time" as const },
                { icon: <DollarSign size={12} />, label: "Cost", value: costWeight, setter: setCostWeight, key: "cost" as const },
                { icon: <Leaf size={12} />, label: "CO₂", value: co2Weight, setter: setCO2Weight, key: "co2" as const },
              ].map((s) => (
      ...
      <style>{`
        .dark .user-bottom-panel,
        .dark [style*="rgba(255,255,255"] {
          /* Dark mode overrides handled by CSS vars */
        }
      `}</style>
    </div>
  );
