    ...
    >
      ...
      >
        ...
        >
          ...
          <div>
            ...
            <div className="text-[9px] text-[var(--muted-foreground)] uppercase">User Terminal</div>
          </div>
        </div>

        <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
          <Link to="/admin" style={{ textDecoration: "none", color: "var(--muted-foreground)", fontSize: "12px", display: "flex", alignItems: "center", gap: "6px", background: "var(--surface-2)", padding: "6px 12px", borderRadius: "8px", border: "1px solid var(--border)" }}>
            <Settings size={14} />
            Admin
          </Link>
          <button
      ...
      >
        ...
        >
          ...
          />
          {nodesLoading && <div className="text-xs text-muted-foreground flex items-center gap-2"><Loader2 className="animate-spin" size={14} /> Loading network...</div>}
